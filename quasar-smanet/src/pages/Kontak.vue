  ...
  <q-page class="q-pa-md">
    <div class="container">
      ...
      <div class="q-mt-xl q-pa-md form-section-container">
        ...
        <q-form @submit.prevent="submitForm" ref="contactForm">
...
// Mendeklarasikan referensi untuk q-form
...
const submitForm = async () => {
  ...
  // Menggunakan metode validate() dari q-form untuk validasi
  const isFormValid = await contactForm.value.validate()

  if (!isFormValid) {
    // Notifikasi sudah ditangani oleh rules pada q-input
    return
  }
  ...
  try {
    ...
    // Mereset validasi form setelah mengosongkan input
    // Memastikan contactForm.value ada sebelum memanggil resetValidation
    await nextTick() // Tunggu siklus update DOM berikutnya
